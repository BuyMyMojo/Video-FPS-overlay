...
def main(args):
    ...
    if args.f == "NV":
        ...
        if __name__ == '__main__':
            pool = Pool()
            pool.starmap(FpsGraphMH, [(CSVPath, transparentBackground, Resolution, Title, PresetFrameRange, colour, BackColour, OutFolder, LineWidth, RemoveBox, RemoveNumbers, ymin, ymax, TextColour)])
